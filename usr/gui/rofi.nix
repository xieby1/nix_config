...
in
{
  ...
  dconf.settings."org/gnome/settings-daemon/plugins/media-keys".custom-keybindings = [
    ...
    "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/rofi_file_doc/"
  ...
  dconf.settings."org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/rofi_file_doc" = {
    binding="<Super>f";
