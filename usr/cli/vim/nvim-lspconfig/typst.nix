{ pkgs, ... }: {
  programs.neovim = {
    ...
    extraLuaConfig = /*lua*/ ''
      ...
      vim.api.nvim_create_user_command("TypstExportPdfOnSaveEnable", function(args)
      ...
      -- Why called TypstExportPdfOnSaveXDisable instead of TypstExportPdfOnSaveDisable:
      -- to make TypstExportPdfOnSaveXDisable rank after TypstExportPdfOnSaveEnable
      vim.api.nvim_create_user_command("TypstExportPdfOnSaveXDisable", function(args)
