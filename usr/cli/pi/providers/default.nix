{ config, ... }: {
  imports = [
    ...
    {yq-merge.".pi/agent/models.json".expr.providers.jw2-deepseek.compat.supportsDeveloperRole = false;}
    (import ./catwalk-to-custom-provider.nix config.ai.jw2-deepseek)
  ];
